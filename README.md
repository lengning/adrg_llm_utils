...
**Description:** Analyzes ADaM R scripts to extract program names, output files, and R functions used.
...
- Extracts all R functions used in the scripts (base R and package functions)
- Generates a table documenting the analysis programs

**Usage:**

Analyze ADaM R scripts:
```bash
...
**Output:** CSV file with columns: `Program Name`, `Output`, `R functions Used`
...
- Function list is limited to first 20 functions for readability
